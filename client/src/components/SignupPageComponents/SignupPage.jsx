...
const SignupPage=({setLoggedIn})=>{
    ...
    useEffect(()=>{
        ...
        if(!((/^[A-Za-z]*$/.test(firstName))&&(/^[A-Za-z]*$/.test(lastName)))){
            element.style.display="block";
            setMandate("First Name and Last Name should contain only characters")
        }
        ...
        else if(!(setpassword===confirmpassword || confirmpassword==="")){
            element.style.display="block";
    ...
    },[firstName,lastName,mail,setpassword,confirmpassword,mandate])
        ...
        <div className="signUp-page">
            <div className="signupcred">
                ...
                <form onSubmit={handleSubmit}>
                    ...
                    <div className="signup-row">
                        <div className="signup-element">
                            <label>Email</label>
                            <input type="text" name="mail" placeholder="yourmail@email.com" onChange={(e)=>setMail(e.target.value)}/>
                        </div>
                        ...
                        <div className="signup-element">
                            ...
                            <select name="country" onChange={(e)=>setCountry(e.target.value)} >
                                ...
                                <option value="Macedonia">Macedonia, TheRepublic of</option>
                    ...
                    <div className="password-row">
                        <div className="password-element">
                            ...
                            <input type="password" name="setpassword" placeholder="Set Password" onChange={(e)=>setSetpassword(e.target.value)}/>
                        </div>
                        <div className="password-element">
            ...
            <div className="login">
                <div className="log-in">
                    ...
                    <NavLink className="nav" to="/">Click here</NavLink>
                    <p> to Log In</p>
                </div>
            </div>
    </div>
